export const projects = [
  ...
  },
  {
    id: "android-2",
    DeveloperType: "android",
    Img: "/assets/projects/android/project2.png",
    Title: "SUNRISE Coffee App",
    Role: "Flutter & Frontend Developer",
    Description: "Developed the mobile application using Flutter and built the admin dashboard using Next.js. Collaborated with backend APIs developed in Laravel and integrated MySQL for data management.",
    Category: "Cross-Platform",
    ProjectLink: "",
    TechStack: ["Flutter", "Next.js", "Laravel", "MySQL", "Git"],
    Github: "",
    Team: ["Khorn saokhouch"],
    Features: [
      ...
      "Menu browsing and quick ordering system",
      "User-friendly interface and navigation"
    ],
    Scope: "Mobile & Full Stack Development",
    TechnicalDetails: "Built the Flutter mobile app for cross-platform support on Android and iOS. Developed the admin dashboard using Next.js. Integrated with Laravel REST APIs and MySQL for data persistence.",
    Hosting: "Local"
  },
  {
    id: "android-3",
    DeveloperType: "android",
    Img: "/assets/projects/project13.png",
    Title: "Booking App",
    Role: "Flutter & Frontend Developer",
    Description: "A comprehensive cross-platform tour booking application, allowing users to discover and book travel experiences on both Android and iOS.",
    Category: "Cross-Platform",
    ProjectLink: "",
    ...
    Scope: "Mobile Development",
    TechnicalDetails: "Built with Flutter for cross-platform support on both Android and iOS. Integrated with backend APIs for real-time booking data.",
    Hosting: "Local"
  }
];
